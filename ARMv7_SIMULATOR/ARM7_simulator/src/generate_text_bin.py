with open("test_straightline_with_cmp.bin", "wb") as f:
    ...
    f.write(bytes.fromhex("06 70 C7 E0"))  # SUB R7, R7, R6
    f.write(bytes.fromhex("07 30 53 E1"))  # CMP R3, R7
    ...
    f.write(bytes.fromhex("08 C0 C8 E2"))  # EOR R12, R12, R8
    ...
    f.write(bytes.fromhex("FE FF FF EA"))  # B .
